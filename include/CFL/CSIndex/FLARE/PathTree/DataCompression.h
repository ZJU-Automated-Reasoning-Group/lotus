...
public:
  DataCompression(vector<vector<int>> _data);
  DataCompression(vector<vector<int>> _data, int _K);
  DataCompression(vector<vector<int>> _data, vector<int> _grts, int _K, int _max);
