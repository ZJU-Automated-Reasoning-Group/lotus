...
public:
  ...
  static void buildGateGraphByNodeFast(Graph &g, bit_vector *isgates, int vid,
                                       int radius, map<int, int> &gateindex,
                                       Graph &gategraph, vector<int> &que,
                                       vector<int> &dist, int &ref);
  static int buildGateGraphByNodeFastWrite(Graph &g, bit_vector *isgates,
                                           int vid, int radius,
                                           map<int, int> &gateindex,
                                           ostream &out, vector<int> &que,
                                           vector<int> &dist, int &ref);
  static int buildGateGraphWrite(Graph &graph, bit_vector *isgate, int radius,
                                 ostream &out);
  ...
  static void collectInLocalGates(Graph &graph, const bit_vector *isgates,
                                  int vid, int radius, vector<int> &ingates);
  static bool BFSOutLocalReach(Graph &graph, const bit_vector *isgates,
                               int radius, int src, int trg,
                               vector<int> &outgates);
  static void collectOutLocalGates(Graph &graph, const bit_vector *isgates,
