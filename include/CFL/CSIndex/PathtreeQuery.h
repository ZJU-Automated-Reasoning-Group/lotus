...
public:
  PathtreeQuery(const char *gatefile, const char *ggfile, const char *indexfile,
                const char *grafile)
      : Query(gatefile, ggfile, indexfile, grafile) {
    dim = 5;
  ...
  PathtreeQuery(const char *filestem, const char *grafile, int _r, double _ps,
                bool mat)
  ...
  PathtreeQuery(const char *filestem, Graph &ig, int _r, double _ps, bool mat,
