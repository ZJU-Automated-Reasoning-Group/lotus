...
// Analysis domain for LLVM IR: nodes are instructions, transfers are tied to
// instructions (edge semantics), and facts are user-defined.
template <typename FactT> struct LLVMEliminationDomain {
