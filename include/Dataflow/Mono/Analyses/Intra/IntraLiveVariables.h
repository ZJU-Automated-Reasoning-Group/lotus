#ifndef LOTUS_DATAFLOW_MONO_ANALYSES_INTRA_INTRALIVEVARIABLES_H_
#define LOTUS_DATAFLOW_MONO_ANALYSES_INTRA_INTRALIVEVARIABLES_H_
...
#endif // LOTUS_DATAFLOW_MONO_ANALYSES_INTRA_INTRALIVEVARIABLES_H_
