...
This is the Lotus-native migration of SVF's default exhaustive `fspta` pipeline,
not a source-level copy. SVF's separate `vfspta` versioned solver and clustering
