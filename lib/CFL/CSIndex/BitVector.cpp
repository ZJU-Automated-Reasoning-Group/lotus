...
bit_vector::bit_vector() : _num_bits(0), _db(NULL) { num_bytes = 0; }

bit_vector::bit_vector(int64_t num_bits) : _num_bits(num_bits), _db(NULL) {
...
bit_vector::~bit_vector() { free(_db); }
