...
public:
  ...
  using Exp = Exp0<D>;
  using E = E0<D>;
  using Engine = InterproceduralEngine<D, NullabilityAnalysis>;
...
findFactForBlock(const InterproceduralNullability::Result &result,
...
bool InterproceduralNullability::Result::isMaybeNull(
...
bool InterproceduralNullability::Result::isMaybeNullMemory(
...
InterproceduralNullability::Result
InterproceduralNullability::run(llvm::Module &M, const Options &options,
                                bool verbose, LinearStrategy linearStrategy) {
