/**
 * @file SMTModel.cpp
 * @brief Implementation of the SMTModel class that represents models from
 * satisfiable SMT formulas
 *
 * This file implements the SMTModel class, which provides access to models
 * generated by the SMT solver when a formula is satisfiable. It provides:
 * - Evaluation of expressions in the context of the model
 * - Extraction of concrete values for variables (integer, boolean)
 * - Debugging information about model contents
 * - Creation of partial models containing only a subset of variables
 *
 * SMTModel objects are created by the SMTSolver when a satisfiable result is
 * obtained, allowing users to inspect the satisfying assignment for their
 * constraints.
 */
