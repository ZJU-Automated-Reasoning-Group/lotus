...
TEST(UnaryInterleavedDyckAdaptiveTest, DistinguishesShallowThresholds) {
...
TEST(UnaryInterleavedDyckAdaptiveTest, SwitchesBetweenBothShallowArms) {
...
TEST(UnaryInterleavedDyckAdaptiveTest, HandlesRepeatedArmAlternation) {
  const Graph graph = bidirectedLinearGraph(
...
TEST(UnaryInterleavedDyckAdaptiveTest,
...
TEST(UnaryInterleavedDyckAdaptiveTest, RejectsNonBidirectedInput) {
  Graph directed;
