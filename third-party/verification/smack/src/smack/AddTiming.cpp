...
static unsigned toUnsignedCost(InstructionCost Cost) {
  Optional<InstructionCost::CostType> Value = Cost.getValue();
  if (!Value || *Value < 0)
...
unsigned AddTiming::getInstructionCost(const Instruction *I) const {
  ...
  case Instruction::GetElementPtr: {
    ...
    return toUnsignedCost(TTI->getAddressComputationCost(ValTy));
  }

  case Instruction::Ret:
  case Instruction::PHI:
  case Instruction::Br: {
    return toUnsignedCost(TTI->getCFInstrCost(
        I->getOpcode(), TargetTransformInfo::TargetCostKind::TCK_Latency, I));
  }
  ...
  case Instruction::Xor: {
    ...
    return toUnsignedCost(TTI->getArithmeticInstrCost(
  ...
  case Instruction::Select: {
    ...
    return toUnsignedCost(TTI->getCmpSelInstrCost(
        I->getOpcode(), I->getType(), CondTy, CmpInst::BAD_ICMP_PREDICATE,
        TargetTransformInfo::TargetCostKind::TCK_Latency, I));
  }
  ...
  case Instruction::FCmp: {
    ...
    return toUnsignedCost(TTI->getCmpSelInstrCost(
        I->getOpcode(), ValTy, nullptr, CI->getPredicate(),
        TargetTransformInfo::TargetCostKind::TCK_Latency, I));
  }
  case Instruction::Store: {
    ...
    return toUnsignedCost(TTI->getMemoryOpCost(
        I->getOpcode(), ValTy, Align(SI->getAlignment()),
  ...
  case Instruction::Load: {
    ...
    return toUnsignedCost(TTI->getMemoryOpCost(
        I->getOpcode(), I->getType(), Align(LI->getAlignment()),
  ...
  case Instruction::AddrSpaceCast: {
    ...
    return toUnsignedCost(TTI->getCastInstrCost(
        I->getOpcode(), I->getType(), SrcTy, TTI->getCastContextHint(I),
        TargetTransformInfo::TargetCostKind::TCK_Latency, I));
  }
  ...
  case Instruction::Call: {
    if (const IntrinsicInst *II = dyn_cast<IntrinsicInst>(I)) {
      ...
      return toUnsignedCost(TTI->getIntrinsicInstrCost(
