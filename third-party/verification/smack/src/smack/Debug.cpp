...
static ::llvm::cl::opt<bool, true> Debug("smack-debug",
                                         cl::desc("Enable SMACK debug output"),
                                         cl::Hidden,
...
static ::llvm::cl::opt<DebugOnlyOpt, true, cl::parser<std::string>>
    DebugOnly("smack-debug-only",
              cl::desc("Enable a specific type of SMACK debug output "
