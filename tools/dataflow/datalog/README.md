...
```text
lotus-datalog run tools/dataflow/datalog/examples/transitive_closure.dl --pretty
```
...
```text
lotus-datalog run \
  tools/dataflow/datalog/examples/multifile/schema.dl \
  tools/dataflow/datalog/examples/multifile/facts/graph.dl \
  tools/dataflow/datalog/examples/multifile/rules/reachability.dl
```

The same example has an include-based entry point:

```text
lotus-datalog run tools/dataflow/datalog/examples/multifile/main.dl
```
...
```text
lotus-datalog run tools/dataflow/datalog/examples/z3_fixedpoint.smt2 --pretty
```
